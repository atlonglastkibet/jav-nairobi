...
graph TD
    Start[Nairobi Matatu Transit Analysis]
    ...
    End[Reduced Uncertainty + # Jav: Deep Learning for Equitable Matatu Routing in Nairobi's Informal Transit Networks
